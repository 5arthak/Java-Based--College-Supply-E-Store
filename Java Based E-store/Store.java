...
//        customerTable.insertCustomer(c2);
        ...
        for(int i = 1; i < OrderList.get_size(); i++) {
            ...
            customerTable.getCustomerInfoByName(fname, lname).getFirst().addOrder(OrderList.get_element(i));;
        ...
        if (o == 1) {
            ...
            do {
                ...
                if (op == 1) {
                    ...
                    System.out.println(customerTable.getCustomerInfoByName(f_name, l_name).getFirst());
                    ...
                    System.out.println("order Number" + OrderList.get_element(1).getId() + " was shipped");
